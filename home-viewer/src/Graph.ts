      ...
      draw: function(cfg: any, group: any) {
        const rect = group.addShape("dom", {
          attrs: {
            ...
            height: cfg.size[1],
            html: `
                  <div style="background-color: #fff; border: 2px solid #5B8FF9; border-radius: 5px; width: ${cfg
                    .size[0] - 5}px; height: ${cfg.size[1] -
              5}px; display: flex;">
                    <div style="height: 100%; width: 33%; background-color: #CDDDFD">
                      <img alt="" style="line-height: 100%; padding-top: 6px; padding-left: 8px;" src=${
                        cfg.logoIcon.img
                      } width="20" height="20" />  
                    </div>
